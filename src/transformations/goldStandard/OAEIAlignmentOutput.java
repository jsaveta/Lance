...
public class OAEIAlignmentOutput extends OutputMappingsFormat {
        ...
        /**
         * Same format than OAEIRDFAlignmentFormat, but with different output.
        ...
        protected void setOutput() throws Exception {
            	...
            	//the third arg is mine.. if you remove it the file will be at : C:/Users/user/AppData/Local/Temp/
                alignmentFile = File.createTempFile(output_file, ".rdf",new File("OAEIGoldStandards\\")); 
      ...
      public void addInstanceMapping2Output(String iri_str1, String iri_str2, double conf)  throws Exception {
        ...
        public void addMapping2Output(String iri_str1, String iri_str2, int dir_mapping, double conf) throws Exception{
                ...
                fw.write("\t\t<measure rdf:datatype=\"xsd:float\">" + conf + "</measure>\n"); //getRoundConfidence(conf)
           
                
                if (dir_mapping==0){ //equality
                    
                    fw.write("\t\t<relation>=</relation>\n");
                    
	            }
	            else if (dir_mapping==1){ //Subclass
	                    
	                    fw.write("\t\t<relation>&lt;</relation>\n");
	            }
	            
	            else if (dir_mapping==2){ //Superclass
